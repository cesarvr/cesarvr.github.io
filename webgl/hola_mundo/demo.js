...
app.demo = {
	...
	addLuz:function(){
		...
		this.luces.luz1 =
		new THREE.PointLight(0xFFFFFF); // luz blanca
	...
	addCubo:function(){
		...
		var material_g 		= new THREE.MeshLambertMaterial({ color: 0xCC0000  });
	...
	addPlano:function(){
		...
		var material = new THREE.MeshLambertMaterial( {color: 0x012201, side: THREE.DoubleSide} ); 
